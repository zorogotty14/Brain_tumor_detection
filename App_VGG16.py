...
MODEL_PATH = "../models/brain_tumor_detection_model_with_others.h5"
...
class_names = ['Others', 'glioma', 'meningioma', 'notumor', 'pituitary']
...
def predict():
    ...
    if predicted_class_name == 'Others' or confidence < CONFIDENCE_THRESHOLD:
